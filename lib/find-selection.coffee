...
module.exports =
  activate: (@state) ->
    ...
    @subs.add atom.commands.add 'atom-text-editor', "fast-sync:find-next",     => @find +1, 'ig'
    @subs.add atom.commands.add 'atom-text-editor', "fast-sync:find-previous", => @find -1, 'ig'
    @subs.add atom.commands.add 'atom-text-editor', "fast-sync:find-next-casesensitive", => @find +1, 'g'
    @subs.add atom.commands.add 'atom-text-editor', "fast-sync:find-previous-casesensitive", => @find -1, 'g'
